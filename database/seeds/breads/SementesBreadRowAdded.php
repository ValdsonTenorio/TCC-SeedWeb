...
class SementesBreadRowAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        try {
            ...
            \DB::table('data_rows')->insert(array (
                ...
                array (
                    'data_type_id' => $dataType->id,
                    'field' => 'quebra_de_dormencia',
                    'type' => 'text',
                    'display_name' => 'Quebra De Dormencia',
                    'required' => 0,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 1,
